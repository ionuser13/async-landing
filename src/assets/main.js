const API = 'https://youtube-v31.p.rapidapi.com/playlistItems?playlistId=PLjT6ePOFLFf3gHO_fXXmikcipOV3ZLYB0&part=snippet&maxResults=5';
...
(async() => {
     try{
        ...
        content.innerHTML = `An error has ocurred: ${error}`
     }
})();
